...
//{
//	public class LostRelic : ModTile
//	{
//		public override void SetStaticDefaults()
//		{
//			TileID.Sets.Ore[Type] = true;
//			Main.tileSpelunker[Type] = false;
//			Main.tileOreFinderPriority[Type] = 760; // Metal Detector value, see https://terraria.gamepedia.com/Metal_Detector
...
//			name.SetDefault("Lost Relic");
//			AddMapEntry(new Color(142, 52, 162), name);
//
//			DustType = 84;
//			ItemDrop = ModContent.ItemType<Items.LostRelic>();
...
//				tasks.Insert(ShiniesIndex + 1, new OrePass("Generating Lost Relics", 237.4298f));
//			}
//		}
//	}
//
...
//			progress.Message = "Generating Lost Relics";
//		
//			// Ores are quite simple, we simply use a for loop and the WorldGen.TileRunner to place splotches of the specified Tile in the world.
//			// "6E-05" is "scientific notation". It simply means 0.00006 but in some ways is easier to read.
//			for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * .01); k++)
//			{
...
//				WorldGen.TileRunner(x, y, 2, 1, ModContent.TileType<LostRelic>());
//		
