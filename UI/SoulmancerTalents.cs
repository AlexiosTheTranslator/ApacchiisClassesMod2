...
namespace ApacchiisClassesMod2.UI
{
    class SoulmancerTalents : UIState
    {
        ...
        float L1Scale = 1f;
        float R1Scale = 1f;
        string L1 = "+2% Soul Rip Chance";
        string R1 = "+12% Ability Power";
        ...
        float L4Scale = 1f;
        float R4Scale = 1f;
        string L4 = "+12 Soul Rip Damage";
        string R4 = "+50 Soul Shatter Range";

        float L5Scale = 1f;
        float R5Scale = 1f;
        string L5 = "-4% Ult Cost";
        string R5 = "+25 Soul Shatter Damage";
        ...
        float L8Scale = 1f;
        float R8Scale = 1f;
        string L8 = "+80 Soul Shatter Range";
        ...
        float L10Scale = 1f;
        float R10Scale = 1f;
        string L10 = "+5% Soul Rip Chance";
        string R10 = "+1.5s Consume Duration";
