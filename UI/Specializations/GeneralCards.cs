                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    switch (slot)
                    {
                        ...
                        case 9:
                            ...
                            effect.SetText($"+{(decimal)(acmPlayer.card_ImpenetrableValue * 100)}% Defense");
                            count.SetText($"{acmPlayer.card_ImpenetrableCount}x");
                            break;

                        case 10:
                            name.SetText("Magical");
                            effect.SetText($"+{(decimal)(acmPlayer.card_MagicalValue * 100)}% Max Mana");
                        ...
                        case 11:
                            ...
                            effect2.SetText($"+{(decimal)(acmPlayer.card_FortifiedValue_2 * 100)}% Defense");
                        ...
                        case 15:
                            ...
                            effect2.SetText($"+{(decimal)(acmPlayer.card_VeteranValue_2 * 100)}% Max Mana");
