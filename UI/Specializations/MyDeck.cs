...
namespace ApacchiisClassesMod2.UI.Specializations
{
    class MyDeck : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            DrawCard.OnClick += ClickDrawCard;
            Append(DrawCard);
                ...
                if (Card[i].IsMouseHovering)
                {
                    switch (i)
                    {
                        ...
                        case 9:
                            ...
                            PanelCardEffect1.SetText($"+{(decimal)(acmPlayer.card_ImpenetrableCount * acmPlayer.card_ImpenetrableValue * 100)}% Defense");
                            PanelCard.Append(PanelCardImage);
                        ...
                        case 10:
                            ...
                            PanelCardEffect1.SetText($"+{(decimal)(acmPlayer.card_MagicalCount * acmPlayer.card_MagicalValue * 100)}% Max Mana");
                            PanelCard.Append(PanelCardImage);
                        ...
                        case 11:
                            ...
                            PanelCardEffect2.SetText($"+{(decimal)(acmPlayer.card_FortifiedCount * acmPlayer.card_FortifiedValue_2 * 100)}% Defense");
                            PanelCard.Append(PanelCardImage);
                        ...
                        case 15:
                            ...
                            PanelCardEffect2.SetText($"+{(decimal)(acmPlayer.card_VeteranCount * acmPlayer.card_VeteranValue_2 * 100)}% Max Mana");
                            PanelCard.Append(PanelCardImage);
