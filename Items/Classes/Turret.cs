...
//                "-(P: Turret)-\n" +
//                "The inventor has an upgradeable sentry turret that can be deployed. The turret will attack nearby enemies\n" +
//                "-(A1: Deploy Turret)-\n" +
//                "The inventor deploys its turret at its current position.\n" +
//                "-(A2: Pocket Cog Shotgun)-\n" +
//                "Fire your cog shotgun, shooting a barrage of 5 fast-moving cogs towards your cursor's position and slightly knocking you back the opposite way.\n" +
//                "-(Ult: Overclock)-\n" +
...
//            acmPlayer.ultChargeMax = 2520;
//            acmPlayer.ability1MaxCooldown = 6;
//            acmPlayer.ability2MaxCooldown = 18;
//
//            stat1 = baseStat1 * _ACMConfigServer.Instance.classStatMult * acmPlayer.classStatMultiplier;
//            stat2 = baseStat2 * _ACMConfigServer.Instance.classStatMult * acmPlayer.classStatMultiplier;
//            stat3 = baseStat3 * _ACMConfigServer.Instance.classStatMult * acmPlayer.classStatMultiplier;
//            badStat = (int)(baseBadStat * _ACMConfigServer.Instance.classStatMult * acmPlayer.classStatMultiplier);
//
